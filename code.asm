...
;      36 #include <delay.h>
;      37 
;      38 // External Interrupt 0 service routine
;      39 interrupt [EXT_INT0] void ext_int0_isr(void)
;      40 {

	.CSEG
_ext_int0_isr:
;      41 if(PIND.1==0) // Place your code here
;      42 {
;      43 }
;      44 }
	RETI
...
;      87 DDRF=0x00;
	STS  97,R30
;      88 
;      89 // Port G initialization
;      90 // Func4=In Func3=In Func2=In Func1=In Func0=In
;      91 // State4=T State3=T State2=T State1=T State0=T
;      92 PORTG=0x00;
	STS  101,R30
;      93 DDRG=0x00;
	STS  100,R30
...
;      97 // Clock value: Timer 0 Stopped
...
;     107 // Clock value: Timer 1 Stopped
;     108 // Mode: Normal top=FFFFh
;     109 // OC1A output: Discon.
;     110 // OC1B output: Discon.
;     111 // OC1C output: Discon.
;     112 // Noise Canceler: Off
;     113 // Input Capture on Falling Edge
;     114 // Timer 1 Overflow Interrupt: Off
;     115 // Input Capture Interrupt: Off
;     116 // Compare A Match Interrupt: Off
;     117 // Compare B Match Interrupt: Off
;     118 // Compare C Match Interrupt: Off
;     119 TCCR1A=0x00;
	OUT  0x2F,R30
;     120 TCCR1B=0x00;
	OUT  0x2E,R30
...
;     130 OCR1CL=0x00;
	STS  120,R30
;     131 
;     132 // Timer/Counter 2 initialization
;     133 // Clock source: System Clock
;     134 // Clock value: Timer 2 Stopped
;     135 // Mode: Normal top=FFh
;     136 // OC2 output: Disconnected
;     137 TCCR2=0x00;
	OUT  0x25,R30
;     138 TCNT2=0x00;
	OUT  0x24,R30
;     139 OCR2=0x00;
	OUT  0x23,R30
;     140 
;     141 // Timer/Counter 3 initialization
;     142 // Clock source: System Clock
;     143 // Clock value: Timer 3 Stopped
;     144 // Mode: Normal top=FFFFh
;     145 // Noise Canceler: Off
;     146 // Input Capture on Falling Edge
;     147 // OC3A output: Discon.
;     148 // OC3B output: Discon.
;     149 // OC3C output: Discon.
;     150 // Timer 3 Overflow Interrupt: Off
;     151 // Input Capture Interrupt: Off
;     152 // Compare A Match Interrupt: Off
;     153 // Compare B Match Interrupt: Off
;     154 // Compare C Match Interrupt: Off
;     155 TCCR3A=0x00;
	STS  139,R30
;     156 TCCR3B=0x00;
	STS  138,R30
...
;     166 OCR3CL=0x00;
	STS  130,R30
;     167 
;     168 // External Interrupt(s) initialization
;     169 // INT0: On
;     170 // INT0 Mode: Rising Edge
;     171 // INT1: Off
;     172 // INT2: Off
;     173 // INT3: Off
;     174 // INT4: Off
...
;     176 // INT6: Off
;     177 // INT7: Off
;     178 EICRA=0x03;//Регистры отвечающие за прерывания
	LDI  R30,LOW(3)
	STS  106,R30
;     179 EICRB=0x00;
	LDI  R30,LOW(0)
...
;     181 EIFR=0x01;
	OUT  0x38,R30
;     182 
;     183 // Timer(s)/Counter(s) Interrupt(s) initialization
;     184 TIMSK=0x00;
	LDI  R30,LOW(0)
	OUT  0x37,R30
;     185 ETIMSK=0x00;
	STS  125,R30
;     186 
;     187 // Analog Comparator initialization
;     188 // Analog Comparator: Off
;     189 // Analog Comparator Input Capture by Timer/Counter 1: Off
;     190 ACSR=0x80;
	LDI  R30,LOW(128)
	OUT  0x8,R30
;     191 SFIOR=0x00;
